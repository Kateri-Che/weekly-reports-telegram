...
**Реализовано в тасках `df_WAU_feed`, `df_WAU_messages`, `graph_WAU `**.

-	Количество просмотров.
-	Количество лайков.
-	Количество сообщений.

**Реализовано в тасках `df_lv_feed`, `df_mi_message`, `graph_lvmi `**.
...
**Реализовано в тасках `df_open_feed`, `df_open_message`, `graph_country`**.

**1.3.** В разрезе **по полу** и **статусу (новые, оставшиеся, ушедшие)**:
- Динамика поведения пользователей. 

**Реализовано в тасках `df_st`, `df_st_m`, `graph_st `**.
